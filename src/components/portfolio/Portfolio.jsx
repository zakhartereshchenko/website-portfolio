...
import marvelAPIPhoto from '/marvel.png';
import todoListPhoto from '/todo-list.png';
import employeesListPhoto from '/employees-list.png';
        ...
        <div className="portfolio" id="portfolio">
            <div className="portfolio__content container">
                ...
                <div className="portfolio__list">
                    <PortfolioItem photoSrc={employeesListPhoto} name="Employees list project." description="App created for practice react in the start my learning React using Classes. 
                    ...
                    <PortfolioItem photoSrc={marvelAPIPhoto} name="Marvel project." description="App created for practice with React Hooks and work with API. In this app you
                    ...
                    <PortfolioItem photoSrc={todoListPhoto} name="Todo list." description="This is a todo list application built to practice with Redux toolkit and
